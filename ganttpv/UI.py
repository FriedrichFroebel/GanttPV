...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.FileMenu.Append(wx.ID_SAVEAS, "Save As...", "Save project file with new name", wx.ITEM_NORMAL)
        self.FileMenu.Append(wx.ID_EXIT, "Quit\tCTRL-Q", "Quit program", wx.ITEM_NORMAL)
        self.main_menubar.Append(self.FileMenu, "File")
        self.Edit = wx.Menu()
        self.Edit.Append(ID.UNDO, "Undo\tCTRL-Z", "Undo last change", wx.ITEM_NORMAL)
        self.Edit.Append(ID.REDO, "Redo", "Redo change", wx.ITEM_NORMAL)
        ...
        self.Help = wx.Menu()
        self.Help.Append(ID.ABOUT, "About GanttPV", "", wx.ITEM_NORMAL)
        self.Help.Append(ID.HOME_PAGE, "GanttPV Home", "", wx.ITEM_NORMAL)
        self.Help.Append(ID.HELP_PAGE, "Help Page", "URL of Help Text", wx.ITEM_NORMAL)
        self.Help.Append(ID.FORUM, "Forum", "URL of Forum", wx.ITEM_NORMAL)
...
class ResourceFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.SetMenuBar(self.resource_menubar)
        self.FileMenu = wx.Menu()
        self.FileMenu.Append(wx.ID_NEW, "New\tCTRL-N", "New project file", wx.ITEM_NORMAL)
        self.FileMenu.Append(wx.ID_OPEN, "Open...\tCTRL-O", "Open existing project file", wx.ITEM_NORMAL)
        self.FileMenu.AppendSeparator()
        self.FileMenu.Append(wx.ID_CLOSE, "Close\tCTRL-W", "Close report", wx.ITEM_NORMAL)
        self.FileMenu.Append(wx.ID_SAVE, "Save\tCTRL-S", "Save project file", wx.ITEM_NORMAL)
        self.FileMenu.Append(wx.ID_SAVEAS, "Save As...", "Save project file with new name", wx.ITEM_NORMAL)
        self.FileMenu.Append(wx.ID_EXIT, "Quit\tCTRL-Q", "Quit program", wx.ITEM_NORMAL)
        self.resource_menubar.Append(self.FileMenu, "File")
        self.Edit = wx.Menu()
        self.Edit.Append(ID.UNDO, "Undo\tCTRL-Z", "Undo last change", wx.ITEM_NORMAL)
        self.Edit.Append(ID.REDO, "Redo", "Redo change", wx.ITEM_NORMAL)
        self.resource_menubar.Append(self.Edit, "Edit")
        self.Script = wx.Menu()
        self.Script.Append(ID.FIND_SCRIPTS, "Find Scripts", "", wx.ITEM_NORMAL)
        self.Script.AppendSeparator()
        self.resource_menubar.Append(self.Script, "Script")
        self.Help = wx.Menu()
        self.Help.Append(ID.ABOUT, "About GanttPV", "", wx.ITEM_NORMAL)
        self.Help.Append(ID.HOME_PAGE, "GanttPV Home", "URL of GanttPV Home Page", wx.ITEM_NORMAL)
        self.Help.Append(ID.HELP_PAGE, "Help Page", "URL of Help Text", wx.ITEM_NORMAL)
        self.Help.Append(ID.FORUM, "Forum", "URL of Forum", wx.ITEM_NORMAL)
        self.resource_menubar.Append(self.Help, "&Help")
        # Menu Bar end
